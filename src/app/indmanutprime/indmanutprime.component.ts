...
import { PoDialogService, PoModalAction, PoModalComponent } from '@portinari/portinari-ui';
...
export class IndmanutprimeComponent implements OnInit {
  ...
  @ViewChild('IssuesCriadas', {static: false}) IssuesCriadas: ChartComponent;
  @ViewChild('IssuesAbertas', {static: false}) IssuesAbertas: ChartComponent;
  @ViewChild('DataPrevCriados', {static: false}) DataPrevCriados: ChartComponent;
  @ViewChild('EnrtregaDetalhada', {static: false}) EnrtregaDetalhada: ChartComponent;
