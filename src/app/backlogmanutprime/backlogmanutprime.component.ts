...
import { PoTableColumn, PoModalAction, PoModalComponent, PoDialogService } from '@portinari/portinari-ui';
...
export class BacklogmanutprimeComponent implements OnInit {
  ...
  serieschart0: Array<any> ;

  // Chart 2 Pizza
  categchart00: Array<string>;
  serieschart00: Array<any> ;
