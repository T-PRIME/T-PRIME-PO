...
export class IndrejectprimeComponent implements OnInit {
  ...
  columnsGrid: Array<any>; // Colunas do grid
  ...
  getColumns(): Array<any> {
    return [
      { property: 'issue', label: 'Issue', type: 'string', width: 10},
      { property: 'nomeFant', label: 'Cliente', type: 'string', width: 16},
      { property: 'reporter', label: 'Reporter', type: 'string', width: 11 },
      { property: 'analista', label: 'Analista', type: 'string', width: 11 },
      { property: 'dtReject', label: 'Dt. Rejeição', type: 'date', width: 7},
      { property: 'motReject', label: 'Motivo Rejeição', type: 'string', width: 11},
      { property: 'descrReject', label: 'Descrição Rejeição' , type: 'string', width: 34}
    ];
  }
